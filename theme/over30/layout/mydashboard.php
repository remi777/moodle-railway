...
/**
 * The over30 Dashboard (/my) layout: reproduces the mockup DashboardView
 * ("Twoje Studio").
 *
 * A copy of Boost's drawers layout so all required output.* wiring is
 * preserved, with an editorial heading injected above the main content via the
 * theme_over30/mydashboard template.
 *
